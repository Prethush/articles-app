            ...
            <main>
                <section>
                    <div className="bg-articlePage text-white py-16 text-center">
                        ...
                        <button className={loggenInUser !== username ? "bg-white text-gray-700 px-8 py-3 rounded-md mt-6" : "hidden"} onClick={this.handleFollow}>{following ? `Unfollow ${username}` : `Follow ${username}`} </button>
                    </div>

                    <article className="px-8 sm:px-12 md:px-40">
                        <div className="py-12">
                            <span className={"cursor-pointer text-md sm:text-xl" + (feedSelected === "author" ? " text-green-500 pb-2 border-b-2 border-green-500" : "")} onClick={() => this.setState({
                                feedSelected: "author",
                                activePage: 1
                            }, this.getArticles)}>
                            ...
                            <span className={"cursor-pointer text-md sm:text-xl" + (feedSelected === "favorited" ? " text-green-500 pb-2 border-b-2 border-green-500" : "")} onClick={() => this.setState({
