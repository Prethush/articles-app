                ...
                <section className="px-20 bg-articlePage text-white py-12">
                   ...
                   <div className="flex flex-col sm:flex-row sm:justify-between">
                       <div className="flex flex-col sm:flex-row sm:justify-between">
                        ...
                        <div className="my-3">
                            <span className={isLoggedIn && user.username === article.author.username ? "bg-blue-500 py-2 px-4 text-white rounded-md mr-4 cursor-pointer": "hidden"} onClick={this.handleEdit}>Edit</span>

                            <span className={isLoggedIn && user.username === article.author.username ? "bg-red-500 py-2 px-4 text-white rounded-md mr-4 cursor-pointer": "hidden"}onClick={this.handleDelete}>Delete</span>
                        </div>
                   </div>
                </section> 
